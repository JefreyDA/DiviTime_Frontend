...
export class FamilyService {
  ...
  joinFamily(idUser: number, link: string) {
    return this.http.put(`${this.url}/join/${idUser}`, link, { responseType: 'text' });
  }

  leaveFamily(idUser: number) {
    return this.http.put(`${this.url}/leave/${idUser}`, {}, { responseType: 'text' });
  }
}
